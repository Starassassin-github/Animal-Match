...
export default function Login() {
    ...
    const loginAccount = async() => {
        ...
        // const response = await axios.post(`http://`, { username: usernameInput, password: passwordInput});
    ...
    return (
        <div className='flex flex-col bg-[#FEE39F] sm:bg-[#FEE39F] h-screen w-screen place-items-center place-content-center'>
            ...
            <div className="flex flex-col w-full max-w-xs">
                <form className="rounded pt-6 pb-8 mb-4" onSubmit={loginAccount}>
                    ...
                    <div className="flex flex-col items-center">
                        <button className="bg-clip-padding bg-gradient-to-b from-[#FF66C4] to-[#8F00FF] transition ease-in-out delay-100 hover:-translate-y-1 hover:scale-110 duration-300 text-white font-bold py-2 px-10 rounded-lg shadow-md shadow-[#8F00FF]/80" type="submit">
                            Login
                        </button>
